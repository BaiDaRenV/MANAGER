	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/admin?method=getBorrow&page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/admin?method=getBorrow&page=1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/admin?method=getBorrow&page="+pages;
			  })
		  })
	  </script>
  </head>
  ...
  <body>
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		...
		<hr class="hr"/>
		<div id="pageControl">
			<div class="pageControl_item">每页<font id="datePrePage">${datePrePage }</font>条数据</div>
